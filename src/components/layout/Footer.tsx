...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/xlinic',
    icon: (props: any) => (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/xlinic',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Şirket</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Destek</h3>
            <ul className="mt-4 space-y-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Yasal</h3>
            <ul className="mt-4 space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Xlinic. Tüm hakları saklıdır.
            </p>
          </div>
        </div>
      </div>
